...
public interface BulkURIFetcher extends URIFetcher {
    ...
    /**
     * Bulk retriever. Depende de la implementaci�n, pero se espera que llamar a
     * este metodo sea mucho m�s eficiente que llamar a fetch con una sola uri.
     * 
     * @param uris
     *            URIs to retrieve
    ...
    /**
     * Bulk retriever. Depende de la implementaci�n, pero se espera que
     * llamar a este metodo sea mucho m�s eficiente que llamar a fetch
     * con una sola uri.
     *
